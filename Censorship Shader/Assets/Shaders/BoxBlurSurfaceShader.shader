Shader "Custom/BoxBlurSurfaceShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            {
                sampleColor += tex2D(_MainTex, IN.uv_MainTex + (i * direction));
                j++;
            }
            ...
            {
                sampleColor += tex2D(_MainTex, IN.uv_MainTex + (n * direction));
                j++;
            }

            o.Albedo =  sampleColor / j;
